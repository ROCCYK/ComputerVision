# -*- coding: utf-8 -*-
"""
Created on Wed Jan 31 23:19:28 2024
...
img = cv2.imread("C:/Users/Downloads/COSC/Week-4/images/BSE.tif", 0)
...
##################MANUAL########################
#Can perform manual segmentation. We did this in earlier code, but it was only for binary case.
...
all_regions[region1] = (1,0,0) # All red pixels corresponds to region1
all_regions[region2] = (0,1,0) # All green pixels corresponds to region2
all_regions[region3] = (0,0,1) # All blue pixels corresponds to region3
all_regions[region4] = (1,1,0) ## All yellow pixels corresponds to region4
...
plt.imshow(regions) #[0-85, 85-136, 136-197, 197-255]
