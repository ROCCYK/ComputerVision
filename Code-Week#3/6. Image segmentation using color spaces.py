...
img = io.imread("C:/Users/xxryk/OneDrive/Desktop/Durham College/3rd Year 2nd Semester/Computer Vision/Code-Week#3/single orange.jpg")
plt.imshow(img)

## Convert RGB to HSV
hsv = cv2.cvtColor(img, cv2.COLOR_RGB2HSV)
mask = cv2.inRange(hsv, (10, 100, 20), (25, 255, 255)) #Blue Color
...
#Draw BB
frame = cv2.rectangle(img, (112,93), (261,239), (0, 255,0),5)
frame = cv2.rectangle(img, (374,155), (594,334), (0, 255,0),5)
#frame = cv2.rectangle(img, (325,190), (395,341), (0, 255,0),5)
plt.imshow(frame)

print(df.sort_values(by=['area'],ascending=False))
