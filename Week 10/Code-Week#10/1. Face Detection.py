...
data_dir = 'C:/Users/Downloads/COSC/Week#10/data'
models_dir = 'C:/Users/Downloads/COSC/Week#10/models'
...
for img_path in os.listdir(data_dir):
    ...
    for face in faces:
        ...
        for eye in eyes:
            ...
            img = cv2.rectangle(img, (x1 + x1e, y1 + y1e), (x1 + x1e + we, y1 + y1e + he), (0, 255, 0), 5)
